...
function Nav({ isNavOpen, onClick }) {
  ...
  return (
    <nav
      className={`${navOpenClosedClasses} absolute top-17 left-0 z-1 flex h-[100vh] w-full items-center justify-center bg-[rgba(255,255,0,0.5)] backdrop-blur transition-all duration-500 md:pointer-events-auto md:relative md:top-auto md:block md:h-auto md:w-auto md:translate-x-0 md:bg-transparent md:opacity-100 md:backdrop-blur-none`}
    >
